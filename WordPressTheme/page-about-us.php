      ...
      <div class="sub-aboutus-top__container">
        ...
        <div class="sub-aboutus-top__body">
          ...
          <div class="sub-aboutus-top__content-wrapper">
            <p class="sub-aboutus-top__text">私たちは、ダイビングを通じて皆様に自然の美しさと感動を届けることを使命としています。経験豊富なインストラクターによる丁寧なサポートと、最新の安全設備を完備しており、初心者から経験者まで安心してお楽しみいただけます。サンゴ礁に囲まれた美しい海を舞台に、多彩なツアーをご用意しています。ダイビングの醍醐味を存分に味わっていただけるよう、私たちは常に最高の環境づくりを心がけています。</p>
          </div>
        </div>
      </div>
    </div>
